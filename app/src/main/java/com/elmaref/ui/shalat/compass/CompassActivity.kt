...
import com.elmaref.databinding.ActivityCompassBinding
...
class CompassActivity : AppCompatActivity() {
    ...
    private fun getBearing() {
        ...
        val qiblaDir = retrieveFloat()
        if (qiblaDir > 0.0001) {
            binding.textCurrentLoc.text = getString(R.string.your_location, gps.latitude, gps.longitude)
            ...
            1 -> {
                ...
                if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                  ...
                  //  binding.textKaabaDir.text = resources.getString(R.string.msg_permission_granted)
                    binding.textCurrentLoc.text = resources.getString(R.string.msg_permission_granted)
                    binding.imgQiblaArrow.visibility = View.INVISIBLE
                    binding.imgQiblaArrow.visibility = View.GONE
         ...
         //   showToast(getString(R.string.your_location, latitude, longitude))
            ...
            if (latitude < 0.001 && longitude < 0.001) {
             ...
             //   showToast("Location not ready, Please Restart Application")
              ...
              //  binding.textKaabaDir.text = getString(R.string.qibla_direction, result2)
                Toast.makeText(
                    this,
